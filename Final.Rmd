...
```
```{r,warning=FALSE,message=FALSE}
logfit<- lm(log(selling_price)~transmission+year+km_driven+fuel+seller_type+owner, data = CAR) # try to figure out the relationship between selling price and other variables 
summary(logfit)
