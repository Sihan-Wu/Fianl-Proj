...
(A) .Rmd Line numbers where at least two different data sources are imported: 23, 24 


(B) .Rmd Line numbers for inspecting data intake: 28 - 35
...
(A) .Rmd Line number(s) for general data wrangling: 44, 45, 48, 58, 59, 60, 61, 63, 70


(B) .Rmd Line number(s) for a join operation: 71


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent):46, 62


(D) .Rmd Line number(s) for use of regular expressions: 


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 45, 61


(F) .Rmd Line number(s) for use of user-defined functions: 48, 53, 64


(G) .Rmd Line number(s) for use of loops and/or control flow: 


(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): 85,86
...
(A) .Rmd Line number(s) for use of mulitple different geoms: 98-99, 112-113, 124-125

(B) .Rmd Line number(s) for use of multiple aesthetics: 96-99, 110-112, 123, 124

(C) .Rmd Line number(s) for use of layered graphics: 98-99, 112-113, 124-125

(D) .Rmd Line number(s) for use of leaflet maps:  

(E) .Rmd Line number(s) for use of decision tree or dendogram results: 85, 86
